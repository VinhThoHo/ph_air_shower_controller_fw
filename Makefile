...
# target
######################################
TARGET = ph_biological_safety_classi_fw
...
ifeq ($(OS),Windows_NT)
	...
	LIB_DIR ?= "D:\STM32Cube\Repository\STM32Cube_FW_F1_V1.8.0"
	CC_PATH ?= "/tools/stm32/gcc/bin"
else
	UNAME_S := $(shell uname -s)
	ifeq ($(UNAME_S),Darwin)
		OPENOCD_DIR ?= /usr/local
		LIB_DIR ?= /Users/nhantt/STM32Cube/Repository/STM32Cube_FW_F1_V1.8.0
